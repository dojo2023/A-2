...
<body>
	<div id="logo_register">
		<img src="/syuudeen/img/syuudeen-logo.png">
	</div>

	<form id="user_register" method="POST"
		action="/syuudeen/UserRegisterServlet">

		<div id="user_register_area">

			<div class="form_group">
				<input type="text" placeholder="１～１２文字の半角英数字で入力してください" id="user_id"
					name="user_id" value="${param.user_id }"> <label for="id"
					class="form_label">ID</label> <span class="focus_line"></span>
				<div id="anim">
			...
			<div class="form_group">
				<input type="password" placeholder="８～２０文字の半角英数字で入力してください"
			...
			<div class="form_group">
				<input type="password" placeholder="パスワードをもう一度入力してください"
					id="pw_check" name="pw_check"> <span id="pw_check_button"
					class="fa fa-eye-slash" onclick="pushHideButton()"></span> <label
					for="id" class="form_label">パスワードチェック</label>
			</div>
		</div>
